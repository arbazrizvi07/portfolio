...
--
-- Host: localhost
-- Generation Time: May 25, 2018 at 05:30 PM
...
INSERT INTO `tbl_projects` (`projectId`, `projectName`, `projectCategory`, `companyNameORClientName`, `logo`, `duration`, `projectURL`, `technology`, `databaseName`, `framework`, `projectManagementTool`, `responsive`, `os`, `thirdPartyComponents`, `description`, `type`, `frameworkORCMSVersion`, `versioning`, `isDeleted`, `createdBy`, `createdDtm`, `updatedBy`, `updatedDtm`) VALUES
(1, 'HOLAA', '', '', '', '', '', '', '', '', '', '', '', '', '', 'MobileWebDesktop', '', '', 0, 1, '2018-05-16 00:00:00', 1, '2018-05-23 00:00:00'),
(2, 'IGIS', '', '', '', '', '', '', '', '', '', '', '', '', '', 'MobileWeb', '', '', 0, 1, '2018-05-16 00:00:00', 1, '2018-05-16 00:00:00');
